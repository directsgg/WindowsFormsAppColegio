...
{
    public partial class FormModalAlumno : Form
    {
        public FormModalAlumno()
        {
            InitializeComponent();
        }
        ...
        private void FormModalAlumno_Load(object sender, EventArgs e)
        {
        ...
        {
            ClassDatosAlumno.carne = dataGridViewAlumno.CurrentRow.Cells["Carne"].Value.ToString();
            ClassDatosAlumno.nombre = dataGridViewAlumno.CurrentRow.Cells["Nombre"].Value.ToString() 
                + " " + dataGridViewAlumno.CurrentRow.Cells["Apellido"].Value.ToString();
            this.Close();
        }
    }
}
