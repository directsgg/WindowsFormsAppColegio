...
{
    public partial class FormListaProfesorCurso : Form
    {
        public FormListaProfesorCurso()
        {
            InitializeComponent();
        }
        ...
        private void FormListaProfesorCurso_Load(object sender, EventArgs e)
        {
        ...
        private void buttonVerAlumnosAsign_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(ClassSeleccionProfesorCurso.codigo))
            {
                FormReporteAsignacion formReporteAsignacion = new FormReporteAsignacion();
                formReporteAsignacion.ShowDialog();
            }
            else
            {
                MessageBox.Show("Seleccione un curso para ver la lista de alumnos asignados");
            }

        }

        private void dataGridViewProfesorCurso_Click(object sender, EventArgs e)
        {
            ClassSeleccionProfesorCurso.codigo = dataGridViewProfesorCurso.CurrentRow.Cells["Codigo"].Value.ToString();
        }
    }
}
