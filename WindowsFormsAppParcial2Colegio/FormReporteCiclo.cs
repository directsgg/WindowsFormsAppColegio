...
{
    public partial class FormReporteCiclo : Form
    {
        public FormReporteCiclo()
        {
            InitializeComponent();
        }
        ...
        private void FormReporteCiclo_Load(object sender, EventArgs e)
        {
            ...
            while (!leer.EndOfStream)
            {
                ...
                if (ClassSeleccionCiclo.codigo == datos[4])
                {
